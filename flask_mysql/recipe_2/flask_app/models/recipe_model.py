...
# allows us to flash messages for validations
from flask import flash

# allow us to use the global variable DATABASE instead of typing in the database name
from flask_app import DATABASE

class Recipe:
    def __init__(self, data):
        # always reference table in MySQL to ensure you aren't missing any columns
        # ensure the attribute names are the same as the column names and in the same order
        self.id = data['id']
        self.name = data['name']
...
# Individual methods here (recipe.do_something())
